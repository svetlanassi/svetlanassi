...
- Мне нравится программировать, так как можно сразу увидеть результат своей работы. Получаю огромное удовольствие от реализации функционала, который удобен и приятен для пользователей.
